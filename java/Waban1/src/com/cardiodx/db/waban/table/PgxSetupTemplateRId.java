...
/**
 * PgxSetupTemplateRId generated by hbm2java
 */
public class PgxSetupTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public PgxSetupTemplateRId() {
	}

	public PgxSetupTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PgxSetupTemplateRId))
			return false;
		PgxSetupTemplateRId castOther = (PgxSetupTemplateRId) other;
