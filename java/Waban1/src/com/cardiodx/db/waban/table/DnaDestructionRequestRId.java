...
/**
 * DnaDestructionRequestRId generated by hbm2java
 */
public class DnaDestructionRequestRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public DnaDestructionRequestRId() {
	}

	public DnaDestructionRequestRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaDestructionRequestRId))
			return false;
		DnaDestructionRequestRId castOther = (DnaDestructionRequestRId) other;
