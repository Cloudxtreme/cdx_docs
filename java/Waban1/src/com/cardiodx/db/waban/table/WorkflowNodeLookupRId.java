...
/**
 * WorkflowNodeLookupRId generated by hbm2java
 */
public class WorkflowNodeLookupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowNodeLookupRId() {
	}

	public WorkflowNodeLookupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowNodeLookupRId))
			return false;
		WorkflowNodeLookupRId castOther = (WorkflowNodeLookupRId) other;
