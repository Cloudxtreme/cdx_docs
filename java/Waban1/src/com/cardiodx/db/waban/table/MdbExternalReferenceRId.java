...
/**
 * MdbExternalReferenceRId generated by hbm2java
 */
public class MdbExternalReferenceRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbExternalReferenceRId() {
	}

	public MdbExternalReferenceRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbExternalReferenceRId))
			return false;
		MdbExternalReferenceRId castOther = (MdbExternalReferenceRId) other;
