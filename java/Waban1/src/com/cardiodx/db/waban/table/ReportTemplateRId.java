...
/**
 * ReportTemplateRId generated by hbm2java
 */
public class ReportTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ReportTemplateRId() {
	}

	public ReportTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReportTemplateRId))
			return false;
		ReportTemplateRId castOther = (ReportTemplateRId) other;
