...
/**
 * InstrumentSetupRId generated by hbm2java
 */
public class InstrumentSetupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public InstrumentSetupRId() {
	}

	public InstrumentSetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InstrumentSetupRId))
			return false;
		InstrumentSetupRId castOther = (InstrumentSetupRId) other;
