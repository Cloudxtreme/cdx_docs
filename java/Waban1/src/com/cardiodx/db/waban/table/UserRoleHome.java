 ...
 * @see com.cardiodx.db.waban.table.UserRole
...
public class UserRoleHome {
	...
	public UserRole findById(java.lang.String id) {
		...
		try {
			UserRole instance = (UserRole) sessionFactory.getCurrentSession()
					.get("com.cardiodx.db.waban.table.UserRole", id);
			if (instance == null) {
	...
	public List<UserRole> findByExample(UserRole instance) {
		...
		try {
			List<UserRole> results = (List<UserRole>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.UserRole")
