...
/**
 * VariableRId generated by hbm2java
 */
public class VariableRId implements java.io.Serializable {
	...
	public VariableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariableRId))
			return false;
		VariableRId castOther = (VariableRId) other;
