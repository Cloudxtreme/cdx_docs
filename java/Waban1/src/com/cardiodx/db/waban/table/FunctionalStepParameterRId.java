...
/**
 * FunctionalStepParameterRId generated by hbm2java
 */
public class FunctionalStepParameterRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public FunctionalStepParameterRId() {
	}

	public FunctionalStepParameterRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FunctionalStepParameterRId))
			return false;
		FunctionalStepParameterRId castOther = (FunctionalStepParameterRId) other;
