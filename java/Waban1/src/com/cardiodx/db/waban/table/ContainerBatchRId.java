...
/**
 * ContainerBatchRId generated by hbm2java
 */
public class ContainerBatchRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ContainerBatchRId() {
	}

	public ContainerBatchRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContainerBatchRId))
			return false;
		ContainerBatchRId castOther = (ContainerBatchRId) other;
