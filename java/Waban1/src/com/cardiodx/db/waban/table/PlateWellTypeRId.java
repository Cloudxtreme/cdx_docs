...
/**
 * PlateWellTypeRId generated by hbm2java
 */
public class PlateWellTypeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public PlateWellTypeRId() {
	}

	public PlateWellTypeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlateWellTypeRId))
			return false;
		PlateWellTypeRId castOther = (PlateWellTypeRId) other;
