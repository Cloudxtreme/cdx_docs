...
/**
 * TestingFacilityRId generated by hbm2java
 */
public class TestingFacilityRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public TestingFacilityRId() {
	}

	public TestingFacilityRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestingFacilityRId))
			return false;
		TestingFacilityRId castOther = (TestingFacilityRId) other;
