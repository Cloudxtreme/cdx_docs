...
/**
 * FunctionalStepRId generated by hbm2java
 */
public class FunctionalStepRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public FunctionalStepRId() {
	}

	public FunctionalStepRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FunctionalStepRId))
			return false;
		FunctionalStepRId castOther = (FunctionalStepRId) other;
