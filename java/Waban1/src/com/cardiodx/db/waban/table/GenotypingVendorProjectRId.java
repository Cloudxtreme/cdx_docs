...
/**
 * GenotypingVendorProjectRId generated by hbm2java
 */
public class GenotypingVendorProjectRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GenotypingVendorProjectRId() {
	}

	public GenotypingVendorProjectRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenotypingVendorProjectRId))
			return false;
		GenotypingVendorProjectRId castOther = (GenotypingVendorProjectRId) other;
