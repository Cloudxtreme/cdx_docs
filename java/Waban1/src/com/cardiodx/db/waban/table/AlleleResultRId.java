...
/**
 * AlleleResultRId generated by hbm2java
 */
public class AlleleResultRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AlleleResultRId() {
	}

	public AlleleResultRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlleleResultRId))
			return false;
		AlleleResultRId castOther = (AlleleResultRId) other;
