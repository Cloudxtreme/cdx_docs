...
/**
 * CaseRoiRId generated by hbm2java
 */
public class CaseRoiRId implements java.io.Serializable {
	...
	public CaseRoiRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaseRoiRId))
			return false;
		CaseRoiRId castOther = (CaseRoiRId) other;
