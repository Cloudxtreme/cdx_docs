...
/**
 * WorkflowStepRId generated by hbm2java
 */
public class WorkflowStepRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowStepRId() {
	}

	public WorkflowStepRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowStepRId))
			return false;
		WorkflowStepRId castOther = (WorkflowStepRId) other;
