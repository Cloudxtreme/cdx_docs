...
/**
 * FreezerRId generated by hbm2java
 */
public class FreezerRId implements java.io.Serializable {
	...
	public FreezerRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreezerRId))
			return false;
		FreezerRId castOther = (FreezerRId) other;
