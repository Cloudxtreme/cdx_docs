...
/**
 * MasterMixItemRId generated by hbm2java
 */
public class MasterMixItemRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MasterMixItemRId() {
	}

	public MasterMixItemRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MasterMixItemRId))
			return false;
		MasterMixItemRId castOther = (MasterMixItemRId) other;
