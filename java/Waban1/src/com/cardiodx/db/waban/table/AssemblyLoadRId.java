...
/**
 * AssemblyLoadRId generated by hbm2java
 */
public class AssemblyLoadRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AssemblyLoadRId() {
	}

	public AssemblyLoadRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssemblyLoadRId))
			return false;
		AssemblyLoadRId castOther = (AssemblyLoadRId) other;
