...
/**
 * AssayResultRId generated by hbm2java
 */
public class AssayResultRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AssayResultRId() {
	}

	public AssayResultRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssayResultRId))
			return false;
		AssayResultRId castOther = (AssayResultRId) other;
