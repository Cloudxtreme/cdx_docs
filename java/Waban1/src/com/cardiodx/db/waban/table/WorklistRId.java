...
/**
 * WorklistRId generated by hbm2java
 */
public class WorklistRId implements java.io.Serializable {
	...
	public WorklistRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorklistRId))
			return false;
		WorklistRId castOther = (WorklistRId) other;
