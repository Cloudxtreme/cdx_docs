...
/**
 * MdbPolymorphismRId generated by hbm2java
 */
public class MdbPolymorphismRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbPolymorphismRId() {
	}

	public MdbPolymorphismRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbPolymorphismRId))
			return false;
		MdbPolymorphismRId castOther = (MdbPolymorphismRId) other;
