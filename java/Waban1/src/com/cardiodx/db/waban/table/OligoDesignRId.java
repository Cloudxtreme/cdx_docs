...
/**
 * OligoDesignRId generated by hbm2java
 */
public class OligoDesignRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public OligoDesignRId() {
	}

	public OligoDesignRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OligoDesignRId))
			return false;
		OligoDesignRId castOther = (OligoDesignRId) other;
