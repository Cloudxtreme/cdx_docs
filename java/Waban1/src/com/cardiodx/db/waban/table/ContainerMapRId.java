...
/**
 * ContainerMapRId generated by hbm2java
 */
public class ContainerMapRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ContainerMapRId() {
	}

	public ContainerMapRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContainerMapRId))
			return false;
		ContainerMapRId castOther = (ContainerMapRId) other;
