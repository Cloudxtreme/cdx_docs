...
/**
 * ProtocolGeneRId generated by hbm2java
 */
public class ProtocolGeneRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ProtocolGeneRId() {
	}

	public ProtocolGeneRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProtocolGeneRId))
			return false;
		ProtocolGeneRId castOther = (ProtocolGeneRId) other;
