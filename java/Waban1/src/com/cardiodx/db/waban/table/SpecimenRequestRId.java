...
/**
 * SpecimenRequestRId generated by hbm2java
 */
public class SpecimenRequestRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public SpecimenRequestRId() {
	}

	public SpecimenRequestRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpecimenRequestRId))
			return false;
		SpecimenRequestRId castOther = (SpecimenRequestRId) other;
