...
/**
 * CaseStatusRId generated by hbm2java
 */
public class CaseStatusRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public CaseStatusRId() {
	}

	public CaseStatusRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaseStatusRId))
			return false;
		CaseStatusRId castOther = (CaseStatusRId) other;
