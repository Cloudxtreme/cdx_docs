...
/**
 * AssayResultLoadRId generated by hbm2java
 */
public class AssayResultLoadRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AssayResultLoadRId() {
	}

	public AssayResultLoadRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssayResultLoadRId))
			return false;
		AssayResultLoadRId castOther = (AssayResultLoadRId) other;
