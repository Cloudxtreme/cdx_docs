...
/**
 * WorkflowNodeRId generated by hbm2java
 */
public class WorkflowNodeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowNodeRId() {
	}

	public WorkflowNodeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowNodeRId))
			return false;
		WorkflowNodeRId castOther = (WorkflowNodeRId) other;
