...
/**
 * TypeListRId generated by hbm2java
 */
public class TypeListRId implements java.io.Serializable {
	...
	public TypeListRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TypeListRId))
			return false;
		TypeListRId castOther = (TypeListRId) other;
