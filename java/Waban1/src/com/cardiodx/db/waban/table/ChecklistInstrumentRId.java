...
/**
 * ChecklistInstrumentRId generated by hbm2java
 */
public class ChecklistInstrumentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ChecklistInstrumentRId() {
	}

	public ChecklistInstrumentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChecklistInstrumentRId))
			return false;
		ChecklistInstrumentRId castOther = (ChecklistInstrumentRId) other;
