...
/**
 * WorkflowDataLookupRId generated by hbm2java
 */
public class WorkflowDataLookupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowDataLookupRId() {
	}

	public WorkflowDataLookupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowDataLookupRId))
			return false;
		WorkflowDataLookupRId castOther = (WorkflowDataLookupRId) other;
