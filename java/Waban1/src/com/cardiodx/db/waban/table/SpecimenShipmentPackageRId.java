...
/**
 * SpecimenShipmentPackageRId generated by hbm2java
 */
public class SpecimenShipmentPackageRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public SpecimenShipmentPackageRId() {
	}

	public SpecimenShipmentPackageRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpecimenShipmentPackageRId))
			return false;
		SpecimenShipmentPackageRId castOther = (SpecimenShipmentPackageRId) other;
