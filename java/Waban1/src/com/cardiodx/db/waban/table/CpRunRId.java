...
/**
 * CpRunRId generated by hbm2java
 */
public class CpRunRId implements java.io.Serializable {
	...
	public CpRunRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CpRunRId))
			return false;
		CpRunRId castOther = (CpRunRId) other;
