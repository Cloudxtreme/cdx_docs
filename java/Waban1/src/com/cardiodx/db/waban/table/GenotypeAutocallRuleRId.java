...
/**
 * GenotypeAutocallRuleRId generated by hbm2java
 */
public class GenotypeAutocallRuleRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GenotypeAutocallRuleRId() {
	}

	public GenotypeAutocallRuleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenotypeAutocallRuleRId))
			return false;
		GenotypeAutocallRuleRId castOther = (GenotypeAutocallRuleRId) other;
