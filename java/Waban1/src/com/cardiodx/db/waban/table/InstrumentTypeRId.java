...
/**
 * InstrumentTypeRId generated by hbm2java
 */
public class InstrumentTypeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public InstrumentTypeRId() {
	}

	public InstrumentTypeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InstrumentTypeRId))
			return false;
		InstrumentTypeRId castOther = (InstrumentTypeRId) other;
