...
/**
 * EventHandlerRId generated by hbm2java
 */
public class EventHandlerRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public EventHandlerRId() {
	}

	public EventHandlerRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EventHandlerRId))
			return false;
		EventHandlerRId castOther = (EventHandlerRId) other;
