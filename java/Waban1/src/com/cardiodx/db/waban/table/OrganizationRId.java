...
/**
 * OrganizationRId generated by hbm2java
 */
public class OrganizationRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public OrganizationRId() {
	}

	public OrganizationRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrganizationRId))
			return false;
		OrganizationRId castOther = (OrganizationRId) other;
