...
/**
 * AssignInstrumentRId generated by hbm2java
 */
public class AssignInstrumentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AssignInstrumentRId() {
	}

	public AssignInstrumentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssignInstrumentRId))
			return false;
		AssignInstrumentRId castOther = (AssignInstrumentRId) other;
