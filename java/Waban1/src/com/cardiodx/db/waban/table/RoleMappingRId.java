...
/**
 * RoleMappingRId generated by hbm2java
 */
public class RoleMappingRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public RoleMappingRId() {
	}

	public RoleMappingRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RoleMappingRId))
			return false;
		RoleMappingRId castOther = (RoleMappingRId) other;
