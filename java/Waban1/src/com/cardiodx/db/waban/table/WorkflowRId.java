...
/**
 * WorkflowRId generated by hbm2java
 */
public class WorkflowRId implements java.io.Serializable {
	...
	public WorkflowRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowRId))
			return false;
		WorkflowRId castOther = (WorkflowRId) other;
