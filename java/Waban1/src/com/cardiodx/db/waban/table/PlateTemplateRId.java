...
/**
 * PlateTemplateRId generated by hbm2java
 */
public class PlateTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public PlateTemplateRId() {
	}

	public PlateTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlateTemplateRId))
			return false;
		PlateTemplateRId castOther = (PlateTemplateRId) other;
