...
/**
 * ChangeTableRId generated by hbm2java
 */
public class ChangeTableRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ChangeTableRId() {
	}

	public ChangeTableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChangeTableRId))
			return false;
		ChangeTableRId castOther = (ChangeTableRId) other;
