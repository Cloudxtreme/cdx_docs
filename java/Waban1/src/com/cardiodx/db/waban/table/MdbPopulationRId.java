...
/**
 * MdbPopulationRId generated by hbm2java
 */
public class MdbPopulationRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbPopulationRId() {
	}

	public MdbPopulationRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbPopulationRId))
			return false;
		MdbPopulationRId castOther = (MdbPopulationRId) other;
