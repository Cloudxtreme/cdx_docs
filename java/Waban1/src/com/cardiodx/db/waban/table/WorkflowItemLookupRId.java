...
/**
 * WorkflowItemLookupRId generated by hbm2java
 */
public class WorkflowItemLookupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowItemLookupRId() {
	}

	public WorkflowItemLookupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowItemLookupRId))
			return false;
		WorkflowItemLookupRId castOther = (WorkflowItemLookupRId) other;
