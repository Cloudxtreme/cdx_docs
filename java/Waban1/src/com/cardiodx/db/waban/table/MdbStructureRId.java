...
/**
 * MdbStructureRId generated by hbm2java
 */
public class MdbStructureRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbStructureRId() {
	}

	public MdbStructureRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbStructureRId))
			return false;
		MdbStructureRId castOther = (MdbStructureRId) other;
