...
/**
 * ParentMenuRId generated by hbm2java
 */
public class ParentMenuRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ParentMenuRId() {
	}

	public ParentMenuRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParentMenuRId))
			return false;
		ParentMenuRId castOther = (ParentMenuRId) other;
