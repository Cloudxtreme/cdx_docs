...
/**
 * MdbClassificationRId generated by hbm2java
 */
public class MdbClassificationRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbClassificationRId() {
	}

	public MdbClassificationRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbClassificationRId))
			return false;
		MdbClassificationRId castOther = (MdbClassificationRId) other;
