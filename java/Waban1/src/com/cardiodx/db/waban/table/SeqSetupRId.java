...
/**
 * SeqSetupRId generated by hbm2java
 */
public class SeqSetupRId implements java.io.Serializable {
	...
	public SeqSetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SeqSetupRId))
			return false;
		SeqSetupRId castOther = (SeqSetupRId) other;
