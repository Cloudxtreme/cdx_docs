...
/**
 * OcxLoadRId generated by hbm2java
 */
public class OcxLoadRId implements java.io.Serializable {
	...
	public OcxLoadRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OcxLoadRId))
			return false;
		OcxLoadRId castOther = (OcxLoadRId) other;
