...
/**
 * GenotypeVariantEntryRId generated by hbm2java
 */
public class GenotypeVariantEntryRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GenotypeVariantEntryRId() {
	}

	public GenotypeVariantEntryRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenotypeVariantEntryRId))
			return false;
		GenotypeVariantEntryRId castOther = (GenotypeVariantEntryRId) other;
