 ...
 * @see com.cardiodx.db.waban.table.Event
	...
	public List<Event> findByExample(Event instance) {
		...
		try {
			List<Event> results = (List<Event>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Event")
