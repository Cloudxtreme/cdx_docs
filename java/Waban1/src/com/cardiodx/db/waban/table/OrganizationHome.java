 ...
 * @see com.cardiodx.db.waban.table.Organization
...
public class OrganizationHome {
	...
	public Organization merge(Organization detachedInstance) {
		...
		try {
			Organization result = (Organization) sessionFactory
	...
	public Organization findById(java.math.BigDecimal id) {
		...
		try {
			Organization instance = (Organization) sessionFactory
					.getCurrentSession().get(
							"com.cardiodx.db.waban.table.Organization", id);
			if (instance == null) {
	...
	public List<Organization> findByExample(Organization instance) {
		...
		try {
			List<Organization> results = (List<Organization>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Organization")
