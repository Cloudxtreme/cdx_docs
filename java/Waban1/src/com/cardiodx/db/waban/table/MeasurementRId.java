...
/**
 * MeasurementRId generated by hbm2java
 */
public class MeasurementRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MeasurementRId() {
	}

	public MeasurementRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MeasurementRId))
			return false;
		MeasurementRId castOther = (MeasurementRId) other;
