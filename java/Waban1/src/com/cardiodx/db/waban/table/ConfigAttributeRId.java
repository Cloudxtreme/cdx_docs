...
/**
 * ConfigAttributeRId generated by hbm2java
 */
public class ConfigAttributeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ConfigAttributeRId() {
	}

	public ConfigAttributeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConfigAttributeRId))
			return false;
		ConfigAttributeRId castOther = (ConfigAttributeRId) other;
