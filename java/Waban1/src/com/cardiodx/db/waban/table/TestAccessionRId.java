...
/**
 * TestAccessionRId generated by hbm2java
 */
public class TestAccessionRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public TestAccessionRId() {
	}

	public TestAccessionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestAccessionRId))
			return false;
		TestAccessionRId castOther = (TestAccessionRId) other;
