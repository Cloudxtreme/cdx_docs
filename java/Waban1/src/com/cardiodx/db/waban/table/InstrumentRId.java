...
/**
 * InstrumentRId generated by hbm2java
 */
public class InstrumentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public InstrumentRId() {
	}

	public InstrumentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InstrumentRId))
			return false;
		InstrumentRId castOther = (InstrumentRId) other;
