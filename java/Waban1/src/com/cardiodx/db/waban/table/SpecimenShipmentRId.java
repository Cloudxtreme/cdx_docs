...
/**
 * SpecimenShipmentRId generated by hbm2java
 */
public class SpecimenShipmentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public SpecimenShipmentRId() {
	}

	public SpecimenShipmentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpecimenShipmentRId))
			return false;
		SpecimenShipmentRId castOther = (SpecimenShipmentRId) other;
