...
/**
 * SpecimenShipmentAirbillRId generated by hbm2java
 */
public class SpecimenShipmentAirbillRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public SpecimenShipmentAirbillRId() {
	}

	public SpecimenShipmentAirbillRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpecimenShipmentAirbillRId))
			return false;
		SpecimenShipmentAirbillRId castOther = (SpecimenShipmentAirbillRId) other;
