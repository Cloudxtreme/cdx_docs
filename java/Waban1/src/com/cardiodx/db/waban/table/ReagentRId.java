...
/**
 * ReagentRId generated by hbm2java
 */
public class ReagentRId implements java.io.Serializable {
	...
	public ReagentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReagentRId))
			return false;
		ReagentRId castOther = (ReagentRId) other;
