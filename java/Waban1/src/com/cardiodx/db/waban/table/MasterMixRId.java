...
/**
 * MasterMixRId generated by hbm2java
 */
public class MasterMixRId implements java.io.Serializable {
	...
	public MasterMixRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MasterMixRId))
			return false;
		MasterMixRId castOther = (MasterMixRId) other;
