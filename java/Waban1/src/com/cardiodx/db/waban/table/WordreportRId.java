...
/**
 * WordreportRId generated by hbm2java
 */
public class WordreportRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WordreportRId() {
	}

	public WordreportRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WordreportRId))
			return false;
		WordreportRId castOther = (WordreportRId) other;
