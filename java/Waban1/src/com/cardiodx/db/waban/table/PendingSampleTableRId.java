...
/**
 * PendingSampleTableRId generated by hbm2java
 */
public class PendingSampleTableRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public PendingSampleTableRId() {
	}

	public PendingSampleTableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PendingSampleTableRId))
			return false;
		PendingSampleTableRId castOther = (PendingSampleTableRId) other;
