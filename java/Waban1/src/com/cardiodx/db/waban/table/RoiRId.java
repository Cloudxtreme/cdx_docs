...
/**
 * RoiRId generated by hbm2java
 */
public class RoiRId implements java.io.Serializable {
	...
	public RoiRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RoiRId))
			return false;
		RoiRId castOther = (RoiRId) other;
