...
/**
 * ContactRId generated by hbm2java
 */
public class ContactRId implements java.io.Serializable {
	...
	public ContactRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContactRId))
			return false;
		ContactRId castOther = (ContactRId) other;
