...
/**
 * SubsidiaryRId generated by hbm2java
 */
public class SubsidiaryRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public SubsidiaryRId() {
	}

	public SubsidiaryRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SubsidiaryRId))
			return false;
		SubsidiaryRId castOther = (SubsidiaryRId) other;
