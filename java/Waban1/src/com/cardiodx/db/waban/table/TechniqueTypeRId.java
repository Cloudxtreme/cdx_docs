...
/**
 * TechniqueTypeRId generated by hbm2java
 */
public class TechniqueTypeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public TechniqueTypeRId() {
	}

	public TechniqueTypeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TechniqueTypeRId))
			return false;
		TechniqueTypeRId castOther = (TechniqueTypeRId) other;
