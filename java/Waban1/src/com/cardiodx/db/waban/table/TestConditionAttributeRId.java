...
/**
 * TestConditionAttributeRId generated by hbm2java
 */
public class TestConditionAttributeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public TestConditionAttributeRId() {
	}

	public TestConditionAttributeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestConditionAttributeRId))
			return false;
		TestConditionAttributeRId castOther = (TestConditionAttributeRId) other;
