...
/**
 * TraceTransferRId generated by hbm2java
 */
public class TraceTransferRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public TraceTransferRId() {
	}

	public TraceTransferRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TraceTransferRId))
			return false;
		TraceTransferRId castOther = (TraceTransferRId) other;
