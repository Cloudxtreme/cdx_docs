...
/**
 * QcReviewRId generated by hbm2java
 */
public class QcReviewRId implements java.io.Serializable {
	...
	public QcReviewRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QcReviewRId))
			return false;
		QcReviewRId castOther = (QcReviewRId) other;
