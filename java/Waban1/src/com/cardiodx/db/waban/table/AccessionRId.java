...
/**
 * AccessionRId generated by hbm2java
 */
public class AccessionRId implements java.io.Serializable {
	...
	public AccessionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AccessionRId))
			return false;
		AccessionRId castOther = (AccessionRId) other;
