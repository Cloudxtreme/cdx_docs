...
/**
 * SchemaTabRId generated by hbm2java
 */
public class SchemaTabRId implements java.io.Serializable {
	...
	public SchemaTabRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SchemaTabRId))
			return false;
		SchemaTabRId castOther = (SchemaTabRId) other;
