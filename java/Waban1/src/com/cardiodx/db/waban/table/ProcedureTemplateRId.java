...
/**
 * ProcedureTemplateRId generated by hbm2java
 */
public class ProcedureTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ProcedureTemplateRId() {
	}

	public ProcedureTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProcedureTemplateRId))
			return false;
		ProcedureTemplateRId castOther = (ProcedureTemplateRId) other;
