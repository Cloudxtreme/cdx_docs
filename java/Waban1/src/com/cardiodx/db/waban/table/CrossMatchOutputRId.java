...
/**
 * CrossMatchOutputRId generated by hbm2java
 */
public class CrossMatchOutputRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public CrossMatchOutputRId() {
	}

	public CrossMatchOutputRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrossMatchOutputRId))
			return false;
		CrossMatchOutputRId castOther = (CrossMatchOutputRId) other;
