...
/**
 * FilenameRId generated by hbm2java
 */
public class FilenameRId implements java.io.Serializable {
	...
	public FilenameRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FilenameRId))
			return false;
		FilenameRId castOther = (FilenameRId) other;
