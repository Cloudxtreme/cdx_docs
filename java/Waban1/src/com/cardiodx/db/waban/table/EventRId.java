...
/**
 * EventRId generated by hbm2java
 */
public class EventRId implements java.io.Serializable {
	...
	public EventRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EventRId))
			return false;
		EventRId castOther = (EventRId) other;
