...
/**
 * ChecklistContentRId generated by hbm2java
 */
public class ChecklistContentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ChecklistContentRId() {
	}

	public ChecklistContentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChecklistContentRId))
			return false;
		ChecklistContentRId castOther = (ChecklistContentRId) other;
