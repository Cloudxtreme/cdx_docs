...
/**
 * ProtocolDefinedVariableRId generated by hbm2java
 */
public class ProtocolDefinedVariableRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ProtocolDefinedVariableRId() {
	}

	public ProtocolDefinedVariableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProtocolDefinedVariableRId))
			return false;
		ProtocolDefinedVariableRId castOther = (ProtocolDefinedVariableRId) other;
