 ...
 * @see com.cardiodx.db.waban.table.Review
...
public class ReviewHome {
	...
	public List<Review> findByExample(Review instance) {
		...
		try {
			List<Review> results = (List<Review>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Review")
