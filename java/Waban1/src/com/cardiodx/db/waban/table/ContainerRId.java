...
/**
 * ContainerRId generated by hbm2java
 */
public class ContainerRId implements java.io.Serializable {
	...
	public ContainerRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContainerRId))
			return false;
		ContainerRId castOther = (ContainerRId) other;
