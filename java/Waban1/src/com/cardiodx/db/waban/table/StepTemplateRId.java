...
/**
 * StepTemplateRId generated by hbm2java
 */
public class StepTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public StepTemplateRId() {
	}

	public StepTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StepTemplateRId))
			return false;
		StepTemplateRId castOther = (StepTemplateRId) other;
