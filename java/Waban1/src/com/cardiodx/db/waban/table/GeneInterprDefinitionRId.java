...
/**
 * GeneInterprDefinitionRId generated by hbm2java
 */
public class GeneInterprDefinitionRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GeneInterprDefinitionRId() {
	}

	public GeneInterprDefinitionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneInterprDefinitionRId))
			return false;
		GeneInterprDefinitionRId castOther = (GeneInterprDefinitionRId) other;
