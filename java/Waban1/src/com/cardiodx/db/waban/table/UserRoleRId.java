...
/**
 * UserRoleRId generated by hbm2java
 */
public class UserRoleRId implements java.io.Serializable {
	...
	public UserRoleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserRoleRId))
			return false;
		UserRoleRId castOther = (UserRoleRId) other;
