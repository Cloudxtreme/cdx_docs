...
/**
 * AnonymizationRequestRId generated by hbm2java
 */
public class AnonymizationRequestRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AnonymizationRequestRId() {
	}

	public AnonymizationRequestRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnonymizationRequestRId))
			return false;
		AnonymizationRequestRId castOther = (AnonymizationRequestRId) other;
