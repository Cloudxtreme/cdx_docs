 ...
 * @see com.cardiodx.db.waban.table.Patient
	...
	public List<Patient> findByExample(Patient instance) {
		...
		try {
			List<Patient> results = (List<Patient>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Patient")
