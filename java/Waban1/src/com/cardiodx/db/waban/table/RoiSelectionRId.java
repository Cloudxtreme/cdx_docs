...
/**
 * RoiSelectionRId generated by hbm2java
 */
public class RoiSelectionRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public RoiSelectionRId() {
	}

	public RoiSelectionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RoiSelectionRId))
			return false;
		RoiSelectionRId castOther = (RoiSelectionRId) other;
