...
/**
 * PlateSummaryRId generated by hbm2java
 */
public class PlateSummaryRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public PlateSummaryRId() {
	}

	public PlateSummaryRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlateSummaryRId))
			return false;
		PlateSummaryRId castOther = (PlateSummaryRId) other;
