...
/**
 * WorkflowItemRId generated by hbm2java
 */
public class WorkflowItemRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowItemRId() {
	}

	public WorkflowItemRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowItemRId))
			return false;
		WorkflowItemRId castOther = (WorkflowItemRId) other;
