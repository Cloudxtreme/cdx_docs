...
/**
 * OutboundRequestRId generated by hbm2java
 */
public class OutboundRequestRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public OutboundRequestRId() {
	}

	public OutboundRequestRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OutboundRequestRId))
			return false;
		OutboundRequestRId castOther = (OutboundRequestRId) other;
