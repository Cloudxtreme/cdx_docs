...
/**
 * ChecklistRId generated by hbm2java
 */
public class ChecklistRId implements java.io.Serializable {
	...
	public ChecklistRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChecklistRId))
			return false;
		ChecklistRId castOther = (ChecklistRId) other;
