...
/**
 * IdentifiedSampleRId generated by hbm2java
 */
public class IdentifiedSampleRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public IdentifiedSampleRId() {
	}

	public IdentifiedSampleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IdentifiedSampleRId))
			return false;
		IdentifiedSampleRId castOther = (IdentifiedSampleRId) other;
