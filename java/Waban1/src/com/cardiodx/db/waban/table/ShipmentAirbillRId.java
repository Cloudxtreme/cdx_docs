...
/**
 * ShipmentAirbillRId generated by hbm2java
 */
public class ShipmentAirbillRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ShipmentAirbillRId() {
	}

	public ShipmentAirbillRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShipmentAirbillRId))
			return false;
		ShipmentAirbillRId castOther = (ShipmentAirbillRId) other;
