...
/**
 * EmailTemplateRId generated by hbm2java
 */
public class EmailTemplateRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public EmailTemplateRId() {
	}

	public EmailTemplateRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EmailTemplateRId))
			return false;
		EmailTemplateRId castOther = (EmailTemplateRId) other;
