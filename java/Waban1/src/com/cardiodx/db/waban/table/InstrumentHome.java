 ...
 * @see com.cardiodx.db.waban.table.Instrument
	...
	public List<Instrument> findByExample(Instrument instance) {
		...
		try {
			List<Instrument> results = (List<Instrument>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Instrument")
