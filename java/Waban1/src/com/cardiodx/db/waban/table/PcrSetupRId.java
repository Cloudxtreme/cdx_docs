...
/**
 * PcrSetupRId generated by hbm2java
 */
public class PcrSetupRId implements java.io.Serializable {
	...
	public PcrSetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PcrSetupRId))
			return false;
		PcrSetupRId castOther = (PcrSetupRId) other;
