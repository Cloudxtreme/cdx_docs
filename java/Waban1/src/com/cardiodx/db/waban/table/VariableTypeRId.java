...
/**
 * VariableTypeRId generated by hbm2java
 */
public class VariableTypeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public VariableTypeRId() {
	}

	public VariableTypeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariableTypeRId))
			return false;
		VariableTypeRId castOther = (VariableTypeRId) other;
