...
/**
 * TestSetupRId generated by hbm2java
 */
public class TestSetupRId implements java.io.Serializable {
	...
	public TestSetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestSetupRId))
			return false;
		TestSetupRId castOther = (TestSetupRId) other;
