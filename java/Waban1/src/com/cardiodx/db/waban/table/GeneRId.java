...
/**
 * GeneRId generated by hbm2java
 */
public class GeneRId implements java.io.Serializable {
	...
	public GeneRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneRId))
			return false;
		GeneRId castOther = (GeneRId) other;
