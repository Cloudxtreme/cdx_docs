...
/**
 * ProtocolAlleleRId generated by hbm2java
 */
public class ProtocolAlleleRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ProtocolAlleleRId() {
	}

	public ProtocolAlleleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProtocolAlleleRId))
			return false;
		ProtocolAlleleRId castOther = (ProtocolAlleleRId) other;
