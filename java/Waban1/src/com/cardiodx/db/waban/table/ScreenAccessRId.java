...
/**
 * ScreenAccessRId generated by hbm2java
 */
public class ScreenAccessRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ScreenAccessRId() {
	}

	public ScreenAccessRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ScreenAccessRId))
			return false;
		ScreenAccessRId castOther = (ScreenAccessRId) other;
