...
/**
 * ShipmentReceiptRId generated by hbm2java
 */
public class ShipmentReceiptRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ShipmentReceiptRId() {
	}

	public ShipmentReceiptRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShipmentReceiptRId))
			return false;
		ShipmentReceiptRId castOther = (ShipmentReceiptRId) other;
