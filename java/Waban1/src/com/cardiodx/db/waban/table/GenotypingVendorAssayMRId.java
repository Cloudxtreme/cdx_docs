...
/**
 * GenotypingVendorAssayMRId generated by hbm2java
 */
public class GenotypingVendorAssayMRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GenotypingVendorAssayMRId() {
	}

	public GenotypingVendorAssayMRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenotypingVendorAssayMRId))
			return false;
		GenotypingVendorAssayMRId castOther = (GenotypingVendorAssayMRId) other;
