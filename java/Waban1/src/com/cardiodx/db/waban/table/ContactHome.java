 ...
 * @see com.cardiodx.db.waban.table.Contact
	...
	public List<Contact> findByExample(Contact instance) {
		...
		try {
			List<Contact> results = (List<Contact>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Contact")
