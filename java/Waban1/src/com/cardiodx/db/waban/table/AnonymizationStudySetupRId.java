...
/**
 * AnonymizationStudySetupRId generated by hbm2java
 */
public class AnonymizationStudySetupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AnonymizationStudySetupRId() {
	}

	public AnonymizationStudySetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnonymizationStudySetupRId))
			return false;
		AnonymizationStudySetupRId castOther = (AnonymizationStudySetupRId) other;
