...
/**
 * MdbLiteratureRId generated by hbm2java
 */
public class MdbLiteratureRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbLiteratureRId() {
	}

	public MdbLiteratureRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbLiteratureRId))
			return false;
		MdbLiteratureRId castOther = (MdbLiteratureRId) other;
