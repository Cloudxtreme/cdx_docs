...
/**
 * AttributeLevelRId generated by hbm2java
 */
public class AttributeLevelRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AttributeLevelRId() {
	}

	public AttributeLevelRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttributeLevelRId))
			return false;
		AttributeLevelRId castOther = (AttributeLevelRId) other;
