...
/**
 * StudyProtocolRId generated by hbm2java
 */
public class StudyProtocolRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public StudyProtocolRId() {
	}

	public StudyProtocolRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StudyProtocolRId))
			return false;
		StudyProtocolRId castOther = (StudyProtocolRId) other;
