...
/**
 * MdbGeneRegionRId generated by hbm2java
 */
public class MdbGeneRegionRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbGeneRegionRId() {
	}

	public MdbGeneRegionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbGeneRegionRId))
			return false;
		MdbGeneRegionRId castOther = (MdbGeneRegionRId) other;
