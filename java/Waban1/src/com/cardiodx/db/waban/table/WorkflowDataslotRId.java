...
/**
 * WorkflowDataslotRId generated by hbm2java
 */
public class WorkflowDataslotRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public WorkflowDataslotRId() {
	}

	public WorkflowDataslotRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowDataslotRId))
			return false;
		WorkflowDataslotRId castOther = (WorkflowDataslotRId) other;
