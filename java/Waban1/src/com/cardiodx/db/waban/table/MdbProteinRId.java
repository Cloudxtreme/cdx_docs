...
/**
 * MdbProteinRId generated by hbm2java
 */
public class MdbProteinRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public MdbProteinRId() {
	}

	public MdbProteinRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MdbProteinRId))
			return false;
		MdbProteinRId castOther = (MdbProteinRId) other;
