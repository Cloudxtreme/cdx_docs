...
/**
 * UppercaseFieldRId generated by hbm2java
 */
public class UppercaseFieldRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public UppercaseFieldRId() {
	}

	public UppercaseFieldRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UppercaseFieldRId))
			return false;
		UppercaseFieldRId castOther = (UppercaseFieldRId) other;
