...
/**
 * AutoaccessionLoadRId generated by hbm2java
 */
public class AutoaccessionLoadRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AutoaccessionLoadRId() {
	}

	public AutoaccessionLoadRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutoaccessionLoadRId))
			return false;
		AutoaccessionLoadRId castOther = (AutoaccessionLoadRId) other;
