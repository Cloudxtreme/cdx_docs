...
/**
 * ZipcodesRId generated by hbm2java
 */
public class ZipcodesRId implements java.io.Serializable {
	...
	public ZipcodesRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ZipcodesRId))
			return false;
		ZipcodesRId castOther = (ZipcodesRId) other;
