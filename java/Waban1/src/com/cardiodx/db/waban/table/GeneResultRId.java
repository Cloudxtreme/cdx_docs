...
/**
 * GeneResultRId generated by hbm2java
 */
public class GeneResultRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public GeneResultRId() {
	}

	public GeneResultRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneResultRId))
			return false;
		GeneResultRId castOther = (GeneResultRId) other;
