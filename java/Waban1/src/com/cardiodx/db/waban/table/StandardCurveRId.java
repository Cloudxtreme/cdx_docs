...
/**
 * StandardCurveRId generated by hbm2java
 */
public class StandardCurveRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public StandardCurveRId() {
	}

	public StandardCurveRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StandardCurveRId))
			return false;
		StandardCurveRId castOther = (StandardCurveRId) other;
