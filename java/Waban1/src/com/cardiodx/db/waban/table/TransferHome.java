 ...
 * @see com.cardiodx.db.waban.table.Transfer
...
public class TransferHome {
	...
	public Transfer merge(Transfer detachedInstance) {
		...
		try {
			Transfer result = (Transfer) sessionFactory.getCurrentSession()
	...
	public Transfer findById(java.math.BigDecimal id) {
		log.debug("getting Transfer instance with id: " + id);
		try {
			Transfer instance = (Transfer) sessionFactory.getCurrentSession()
					.get("com.cardiodx.db.waban.table.Transfer", id);
			if (instance == null) {
	...
	public List<Transfer> findByExample(Transfer instance) {
		...
		try {
			List<Transfer> results = (List<Transfer>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.cardiodx.db.waban.table.Transfer")
