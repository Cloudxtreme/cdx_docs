...
/**
 * AlleleRId generated by hbm2java
 */
public class AlleleRId implements java.io.Serializable {
	...
	public AlleleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlleleRId))
			return false;
		AlleleRId castOther = (AlleleRId) other;
