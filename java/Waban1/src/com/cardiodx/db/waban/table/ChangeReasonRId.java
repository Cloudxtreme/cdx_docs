...
/**
 * ChangeReasonRId generated by hbm2java
 */
public class ChangeReasonRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public ChangeReasonRId() {
	}

	public ChangeReasonRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChangeReasonRId))
			return false;
		ChangeReasonRId castOther = (ChangeReasonRId) other;
