...
/**
 * DilutionViewId generated by hbm2java
 */
public class DilutionViewId implements java.io.Serializable {
	...
	public DilutionViewId() {
	}

	public DilutionViewId(BigDecimal column) {
		this.column = column;
	}

	public DilutionViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DilutionViewId))
			return false;
		DilutionViewId castOther = (DilutionViewId) other;
