...
/**
 * TimeForecastViewId generated by hbm2java
 */
public class TimeForecastViewId implements java.io.Serializable {
	...
	public TimeForecastViewId() {
	}

	public TimeForecastViewId(BigDecimal studyProtocolId, String variableName) {
		this.studyProtocolId = studyProtocolId;
		this.variableName = variableName;
	}

	public TimeForecastViewId(BigDecimal studyProtocolId, String studyNumber,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TimeForecastViewId))
			return false;
		TimeForecastViewId castOther = (TimeForecastViewId) other;
