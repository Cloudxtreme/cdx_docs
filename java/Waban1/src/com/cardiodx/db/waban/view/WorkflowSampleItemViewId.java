...
/**
 * WorkflowSampleItemViewId generated by hbm2java
 */
public class WorkflowSampleItemViewId implements java.io.Serializable {
	...
	public WorkflowSampleItemViewId() {
	}

	public WorkflowSampleItemViewId(BigDecimal workflowItemId,
	...
	public WorkflowSampleItemViewId(BigDecimal workflowId,
			BigDecimal workflowItemId, String accessionNumber,
			String sampleBarcode, String studyNumber, String status,
			Date dateCreated, Date dateCompleted, BigDecimal studyProtocolId,
			BigDecimal accessionId, String errNumber, String errDescription,
			String lastProcResult, BigDecimal sampleId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowSampleItemViewId))
			return false;
		WorkflowSampleItemViewId castOther = (WorkflowSampleItemViewId) other;
		...
		return ((this.getWorkflowId() == castOther.getWorkflowId()) || (this
				...
				&& ((this.getSampleBarcode() == castOther.getSampleBarcode()) || (this
						.getSampleBarcode() != null
						&& castOther.getSampleBarcode() != null && this
						.getSampleBarcode()
						.equals(castOther.getSampleBarcode())))
