...
/**
 * SeqSetupDisplayViewId generated by hbm2java
 */
public class SeqSetupDisplayViewId implements java.io.Serializable {
	...
	public SeqSetupDisplayViewId() {
	}

	public SeqSetupDisplayViewId(BigDecimal sampleId, BigDecimal checklistId) {
		this.sampleId = sampleId;
		this.checklistId = checklistId;
	}

	public SeqSetupDisplayViewId(String containerId, BigDecimal sampleId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SeqSetupDisplayViewId))
			return false;
		SeqSetupDisplayViewId castOther = (SeqSetupDisplayViewId) other;
