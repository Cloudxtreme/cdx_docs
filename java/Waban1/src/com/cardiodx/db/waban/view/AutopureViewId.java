...
/**
 * AutopureViewId generated by hbm2java
 */
public class AutopureViewId implements java.io.Serializable {
	...
	public AutopureViewId() {
	}

	public AutopureViewId(BigDecimal column) {
		this.column = column;
	}

	public AutopureViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutopureViewId))
			return false;
		AutopureViewId castOther = (AutopureViewId) other;
