...
/**
 * LoadgelViewId generated by hbm2java
 */
public class LoadgelViewId implements java.io.Serializable {
	...
	public LoadgelViewId() {
	}

	public LoadgelViewId(BigDecimal column) {
		this.column = column;
	}

	public LoadgelViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LoadgelViewId))
			return false;
		LoadgelViewId castOther = (LoadgelViewId) other;
