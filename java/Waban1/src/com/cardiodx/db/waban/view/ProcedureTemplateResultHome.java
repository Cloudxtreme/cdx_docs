 ...
 * @see com.cardiodx.db.waban.view.ProcedureTemplateResult
...
public class ProcedureTemplateResultHome {
	...
	public ProcedureTemplateResult findById(
			com.cardiodx.db.waban.view.ProcedureTemplateResultId id) {
		...
		try {
			ProcedureTemplateResult instance = (ProcedureTemplateResult) sessionFactory
					.getCurrentSession()
					.get("com.cardiodx.db.waban.view.ProcedureTemplateResult",
							id);
			if (instance == null) {
	...
	public List<ProcedureTemplateResult> findByExample(
		...
		try {
			List<ProcedureTemplateResult> results = (List<ProcedureTemplateResult>) sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.cardiodx.db.waban.view.ProcedureTemplateResult")
