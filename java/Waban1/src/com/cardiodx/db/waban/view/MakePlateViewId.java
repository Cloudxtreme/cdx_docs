...
/**
 * MakePlateViewId generated by hbm2java
 */
public class MakePlateViewId implements java.io.Serializable {
	...
	public MakePlateViewId() {
	}

	public MakePlateViewId(BigDecimal column) {
		this.column = column;
	}

	public MakePlateViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MakePlateViewId))
			return false;
		MakePlateViewId castOther = (MakePlateViewId) other;
