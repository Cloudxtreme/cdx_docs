...
/**
 * TransferViewId generated by hbm2java
 */
public class TransferViewId implements java.io.Serializable {
	...
	public TransferViewId() {
	}

	public TransferViewId(BigDecimal column) {
		this.column = column;
	}

	public TransferViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransferViewId))
			return false;
		TransferViewId castOther = (TransferViewId) other;
