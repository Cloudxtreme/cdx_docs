...
/**
 * ReagentAddFunViewId generated by hbm2java
 */
public class ReagentAddFunViewId implements java.io.Serializable {
	...
	public ReagentAddFunViewId() {
	}

	public ReagentAddFunViewId(BigDecimal checklistId) {
		this.checklistId = checklistId;
	}

	public ReagentAddFunViewId(BigDecimal column, String sampleTube,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReagentAddFunViewId))
			return false;
		ReagentAddFunViewId castOther = (ReagentAddFunViewId) other;
