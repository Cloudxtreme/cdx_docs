...
/**
 * WorkflowItemViewId generated by hbm2java
 */
public class WorkflowItemViewId implements java.io.Serializable {
	...
	public WorkflowItemViewId() {
	}

	public WorkflowItemViewId(BigDecimal workflowItemId,
	...
	public WorkflowItemViewId(BigDecimal workflowId, BigDecimal workflowItemId,
			String accessionNumber, String studyNumber, String status,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WorkflowItemViewId))
			return false;
		WorkflowItemViewId castOther = (WorkflowItemViewId) other;
