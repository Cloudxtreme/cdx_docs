...
/**
 * IdentifiedSampleViewId generated by hbm2java
 */
public class IdentifiedSampleViewId implements java.io.Serializable {
	...
	public IdentifiedSampleViewId() {
	}

	public IdentifiedSampleViewId(BigDecimal sampleId) {
		this.sampleId = sampleId;
	}

	public IdentifiedSampleViewId(BigDecimal sampleId, String sampleTubeId,
			...
			Date dateReceived, BigDecimal volume, BigDecimal concentration,
			BigDecimal yield, Boolean finalStorageTube, String sampleStatus,
			Date sampleShipped, String createdBy, Date dateCreated,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IdentifiedSampleViewId))
			return false;
		IdentifiedSampleViewId castOther = (IdentifiedSampleViewId) other;
