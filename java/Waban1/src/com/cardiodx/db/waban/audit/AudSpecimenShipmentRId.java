...
/**
 * AudSpecimenShipmentRId generated by hbm2java
 */
public class AudSpecimenShipmentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSpecimenShipmentRId() {
	}

	public AudSpecimenShipmentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSpecimenShipmentRId))
			return false;
		AudSpecimenShipmentRId castOther = (AudSpecimenShipmentRId) other;
