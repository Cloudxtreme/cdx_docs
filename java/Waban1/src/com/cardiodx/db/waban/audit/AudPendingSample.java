...
/**
 * AudPendingSample generated by hbm2java
 */
public class AudPendingSample implements java.io.Serializable {
	...
	public AudPendingSample() {
	}

	public AudPendingSample(BigDecimal auditId, BigDecimal pendingSampleId,
	...
	public AudPendingSample(BigDecimal auditId, BigDecimal changeReasonId,
			BigDecimal pendingSampleId, String sponsorSampleTubeId,
			String sponsorAccessionId, BigDecimal studyProtocolId,
			BigDecimal accessionId, BigDecimal sampleId,
			BigDecimal autoaccessionLoadId, boolean pending, BigDecimal volume,
			BigDecimal concentration, Boolean finalStorageTube,
			String sourceType, String createdBy, Date dateCreated,
			String accessionedBy, Date dateAccessioned, String changedBy,
