...
/**
 * AudShipmentPackageRId generated by hbm2java
 */
public class AudShipmentPackageRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudShipmentPackageRId() {
	}

	public AudShipmentPackageRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudShipmentPackageRId))
			return false;
		AudShipmentPackageRId castOther = (AudShipmentPackageRId) other;
