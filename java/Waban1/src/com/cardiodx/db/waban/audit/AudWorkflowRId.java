...
/**
 * AudWorkflowRId generated by hbm2java
 */
public class AudWorkflowRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudWorkflowRId() {
	}

	public AudWorkflowRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudWorkflowRId))
			return false;
		AudWorkflowRId castOther = (AudWorkflowRId) other;
