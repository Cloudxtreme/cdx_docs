...
/**
 * AudShipmentReceiptRId generated by hbm2java
 */
public class AudShipmentReceiptRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudShipmentReceiptRId() {
	}

	public AudShipmentReceiptRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudShipmentReceiptRId))
			return false;
		AudShipmentReceiptRId castOther = (AudShipmentReceiptRId) other;
