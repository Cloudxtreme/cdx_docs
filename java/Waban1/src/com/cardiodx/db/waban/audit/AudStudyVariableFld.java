...
/**
 * AudStudyVariableFld generated by hbm2java
 */
public class AudStudyVariableFld implements java.io.Serializable {
	...
	public AudStudyVariableFld() {
	}

	public AudStudyVariableFld(BigDecimal auditId,
			BigDecimal studyVariableFldId, BigDecimal protocolDefinedVariableId) {
		this.auditId = auditId;
		this.studyVariableFldId = studyVariableFldId;
		this.protocolDefinedVariableId = protocolDefinedVariableId;
	}

	public AudStudyVariableFld(BigDecimal auditId, BigDecimal changeReasonId,
			BigDecimal studyVariableFldId,
			BigDecimal protocolDefinedVariableId, BigDecimal organizationId,
			BigDecimal contactId, BigDecimal studyProtocolId, String value,
