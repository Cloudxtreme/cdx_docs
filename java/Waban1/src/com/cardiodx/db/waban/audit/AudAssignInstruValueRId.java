...
/**
 * AudAssignInstruValueRId generated by hbm2java
 */
public class AudAssignInstruValueRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudAssignInstruValueRId() {
	}

	public AudAssignInstruValueRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudAssignInstruValueRId))
			return false;
		AudAssignInstruValueRId castOther = (AudAssignInstruValueRId) other;
