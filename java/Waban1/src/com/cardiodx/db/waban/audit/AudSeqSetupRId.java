...
/**
 * AudSeqSetupRId generated by hbm2java
 */
public class AudSeqSetupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSeqSetupRId() {
	}

	public AudSeqSetupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSeqSetupRId))
			return false;
		AudSeqSetupRId castOther = (AudSeqSetupRId) other;
