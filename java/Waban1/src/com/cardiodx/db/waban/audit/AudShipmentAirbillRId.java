...
/**
 * AudShipmentAirbillRId generated by hbm2java
 */
public class AudShipmentAirbillRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudShipmentAirbillRId() {
	}

	public AudShipmentAirbillRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudShipmentAirbillRId))
			return false;
		AudShipmentAirbillRId castOther = (AudShipmentAirbillRId) other;
