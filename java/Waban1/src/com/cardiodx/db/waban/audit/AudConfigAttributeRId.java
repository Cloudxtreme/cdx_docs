...
/**
 * AudConfigAttributeRId generated by hbm2java
 */
public class AudConfigAttributeRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudConfigAttributeRId() {
	}

	public AudConfigAttributeRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudConfigAttributeRId))
			return false;
		AudConfigAttributeRId castOther = (AudConfigAttributeRId) other;
