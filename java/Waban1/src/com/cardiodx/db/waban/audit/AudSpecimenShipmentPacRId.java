...
/**
 * AudSpecimenShipmentPacRId generated by hbm2java
 */
public class AudSpecimenShipmentPacRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSpecimenShipmentPacRId() {
	}

	public AudSpecimenShipmentPacRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSpecimenShipmentPacRId))
			return false;
		AudSpecimenShipmentPacRId castOther = (AudSpecimenShipmentPacRId) other;
