...
/**
 * AudTraceQcRId generated by hbm2java
 */
public class AudTraceQcRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudTraceQcRId() {
	}

	public AudTraceQcRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudTraceQcRId))
			return false;
		AudTraceQcRId castOther = (AudTraceQcRId) other;
