...
/**
 * AudOrganizationVariableRId generated by hbm2java
 */
public class AudOrganizationVariableRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudOrganizationVariableRId() {
	}

	public AudOrganizationVariableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudOrganizationVariableRId))
			return false;
		AudOrganizationVariableRId castOther = (AudOrganizationVariableRId) other;
