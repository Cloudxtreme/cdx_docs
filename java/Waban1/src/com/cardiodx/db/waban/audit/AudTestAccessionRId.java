...
/**
 * AudTestAccessionRId generated by hbm2java
 */
public class AudTestAccessionRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudTestAccessionRId() {
	}

	public AudTestAccessionRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudTestAccessionRId))
			return false;
		AudTestAccessionRId castOther = (AudTestAccessionRId) other;
