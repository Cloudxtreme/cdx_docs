...
/**
 * AudPatientVariableFld generated by hbm2java
 */
public class AudPatientVariableFld implements java.io.Serializable {
	...
	public AudPatientVariableFld() {
	}

	public AudPatientVariableFld(BigDecimal auditId,
			BigDecimal patientVariableFldId,
	...
	public AudPatientVariableFld(BigDecimal auditId, BigDecimal changeReasonId,
			BigDecimal patientVariableFldId,
			BigDecimal protocolDefinedVariableId, BigDecimal organizationId,
			BigDecimal contactId, BigDecimal patientId, String value,
