...
/**
 * AudCaseRoiRId generated by hbm2java
 */
public class AudCaseRoiRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudCaseRoiRId() {
	}

	public AudCaseRoiRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudCaseRoiRId))
			return false;
		AudCaseRoiRId castOther = (AudCaseRoiRId) other;
