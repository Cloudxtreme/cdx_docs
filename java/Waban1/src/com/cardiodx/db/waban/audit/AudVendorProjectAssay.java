...
/**
 * AudVendorProjectAssay generated by hbm2java
 */
public class AudVendorProjectAssay implements java.io.Serializable {
	...
	public AudVendorProjectAssay() {
	}

	public AudVendorProjectAssay(BigDecimal auditId, BigDecimal projectId,
			BigDecimal studyProtocolId, BigDecimal assayId) {
	...
	public AudVendorProjectAssay(BigDecimal auditId, BigDecimal changeReasonId,
			BigDecimal genotypingVendorAssayId, BigDecimal projectId,
			BigDecimal studyProtocolId, BigDecimal assayId, Boolean tested,
