...
/**
 * AudSpecimenRequestRId generated by hbm2java
 */
public class AudSpecimenRequestRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSpecimenRequestRId() {
	}

	public AudSpecimenRequestRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSpecimenRequestRId))
			return false;
		AudSpecimenRequestRId castOther = (AudSpecimenRequestRId) other;
