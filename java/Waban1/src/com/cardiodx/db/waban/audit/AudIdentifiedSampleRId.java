...
/**
 * AudIdentifiedSampleRId generated by hbm2java
 */
public class AudIdentifiedSampleRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudIdentifiedSampleRId() {
	}

	public AudIdentifiedSampleRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudIdentifiedSampleRId))
			return false;
		AudIdentifiedSampleRId castOther = (AudIdentifiedSampleRId) other;
