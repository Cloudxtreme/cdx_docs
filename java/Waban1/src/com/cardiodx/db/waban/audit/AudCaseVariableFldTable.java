...
/**
 * AudCaseVariableFldTable generated by hbm2java
 */
public class AudCaseVariableFldTable implements java.io.Serializable {
	...
	public AudCaseVariableFldTable() {
	}

	public AudCaseVariableFldTable(BigDecimal auditId) {
		this.auditId = auditId;
	}

	public AudCaseVariableFldTable(BigDecimal auditId,
			BigDecimal changeReasonId, BigDecimal caseVariableFldId,
			BigDecimal testAccessionId, BigDecimal protocolDefinedVariableId,
