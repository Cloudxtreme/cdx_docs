...
/**
 * AudCaseOrdersRId generated by hbm2java
 */
public class AudCaseOrdersRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudCaseOrdersRId() {
	}

	public AudCaseOrdersRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudCaseOrdersRId))
			return false;
		AudCaseOrdersRId castOther = (AudCaseOrdersRId) other;
