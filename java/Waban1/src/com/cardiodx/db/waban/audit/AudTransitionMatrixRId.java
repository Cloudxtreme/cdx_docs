...
/**
 * AudTransitionMatrixRId generated by hbm2java
 */
public class AudTransitionMatrixRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudTransitionMatrixRId() {
	}

	public AudTransitionMatrixRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudTransitionMatrixRId))
			return false;
		AudTransitionMatrixRId castOther = (AudTransitionMatrixRId) other;
