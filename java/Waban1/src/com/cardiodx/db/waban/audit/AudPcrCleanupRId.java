...
/**
 * AudPcrCleanupRId generated by hbm2java
 */
public class AudPcrCleanupRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudPcrCleanupRId() {
	}

	public AudPcrCleanupRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudPcrCleanupRId))
			return false;
		AudPcrCleanupRId castOther = (AudPcrCleanupRId) other;
