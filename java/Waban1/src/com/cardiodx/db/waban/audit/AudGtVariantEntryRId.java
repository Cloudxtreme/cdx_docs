...
/**
 * AudGtVariantEntryRId generated by hbm2java
 */
public class AudGtVariantEntryRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudGtVariantEntryRId() {
	}

	public AudGtVariantEntryRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudGtVariantEntryRId))
			return false;
		AudGtVariantEntryRId castOther = (AudGtVariantEntryRId) other;
