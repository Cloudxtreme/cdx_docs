...
/**
 * AudIdentifiedSampleAttRId generated by hbm2java
 */
public class AudIdentifiedSampleAttRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudIdentifiedSampleAttRId() {
	}

	public AudIdentifiedSampleAttRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudIdentifiedSampleAttRId))
			return false;
		AudIdentifiedSampleAttRId castOther = (AudIdentifiedSampleAttRId) other;
