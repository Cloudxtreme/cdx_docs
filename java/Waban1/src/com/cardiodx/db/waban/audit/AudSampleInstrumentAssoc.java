...
/**
 * AudSampleInstrumentAssoc generated by hbm2java
 */
public class AudSampleInstrumentAssoc implements java.io.Serializable {
	...
	public AudSampleInstrumentAssoc() {
	}

	public AudSampleInstrumentAssoc(BigDecimal auditId) {
		this.auditId = auditId;
	}

	public AudSampleInstrumentAssoc(BigDecimal auditId,
			BigDecimal changeReasonId, BigDecimal instrumentId,
			String containerId, BigDecimal checklistId,
			BigDecimal stepTemplateId, String createdBy, Date dateCreated,
