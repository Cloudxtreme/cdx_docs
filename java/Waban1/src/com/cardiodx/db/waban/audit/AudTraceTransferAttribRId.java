...
/**
 * AudTraceTransferAttribRId generated by hbm2java
 */
public class AudTraceTransferAttribRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudTraceTransferAttribRId() {
	}

	public AudTraceTransferAttribRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudTraceTransferAttribRId))
			return false;
		AudTraceTransferAttribRId castOther = (AudTraceTransferAttribRId) other;
