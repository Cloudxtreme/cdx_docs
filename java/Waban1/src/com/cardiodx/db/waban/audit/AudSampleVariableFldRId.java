...
/**
 * AudSampleVariableFldRId generated by hbm2java
 */
public class AudSampleVariableFldRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSampleVariableFldRId() {
	}

	public AudSampleVariableFldRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSampleVariableFldRId))
			return false;
		AudSampleVariableFldRId castOther = (AudSampleVariableFldRId) other;
