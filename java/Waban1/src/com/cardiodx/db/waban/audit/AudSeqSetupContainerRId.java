...
/**
 * AudSeqSetupContainerRId generated by hbm2java
 */
public class AudSeqSetupContainerRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudSeqSetupContainerRId() {
	}

	public AudSeqSetupContainerRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudSeqSetupContainerRId))
			return false;
		AudSeqSetupContainerRId castOther = (AudSeqSetupContainerRId) other;
