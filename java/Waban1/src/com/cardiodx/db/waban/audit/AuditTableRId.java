...
/**
 * AuditTableRId generated by hbm2java
 */
public class AuditTableRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AuditTableRId() {
	}

	public AuditTableRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AuditTableRId))
			return false;
		AuditTableRId castOther = (AuditTableRId) other;
