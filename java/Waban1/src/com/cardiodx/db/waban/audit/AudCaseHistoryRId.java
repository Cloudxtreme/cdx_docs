...
/**
 * AudCaseHistoryRId generated by hbm2java
 */
public class AudCaseHistoryRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudCaseHistoryRId() {
	}

	public AudCaseHistoryRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudCaseHistoryRId))
			return false;
		AudCaseHistoryRId castOther = (AudCaseHistoryRId) other;
