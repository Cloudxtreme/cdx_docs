...
/**
 * AudConfigReagentRId generated by hbm2java
 */
public class AudConfigReagentRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudConfigReagentRId() {
	}

	public AudConfigReagentRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudConfigReagentRId))
			return false;
		AudConfigReagentRId castOther = (AudConfigReagentRId) other;
