...
/**
 * AudQcReviewRId generated by hbm2java
 */
public class AudQcReviewRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudQcReviewRId() {
	}

	public AudQcReviewRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudQcReviewRId))
			return false;
		AudQcReviewRId castOther = (AudQcReviewRId) other;
