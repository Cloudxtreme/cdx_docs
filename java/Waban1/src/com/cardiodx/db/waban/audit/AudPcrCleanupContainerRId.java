...
/**
 * AudPcrCleanupContainerRId generated by hbm2java
 */
public class AudPcrCleanupContainerRId implements java.io.Serializable {

	private BigDecimal parentId;
	private BigDecimal childId;

	public AudPcrCleanupContainerRId() {
	}

	public AudPcrCleanupContainerRId(BigDecimal parentId, BigDecimal childId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AudPcrCleanupContainerRId))
			return false;
		AudPcrCleanupContainerRId castOther = (AudPcrCleanupContainerRId) other;
