 ...
 * @see com.vaannila.course.Course
...
public class CourseHome {
    ...
    public Course merge(Course detachedInstance) {
        ...
        try {
            Course result = (Course) sessionFactory.getCurrentSession()
    ...
    public Course findById( long id) {
        ...
        try {
            Course instance = (Course) sessionFactory.getCurrentSession()
                    .get("com.vaannila.course.Course", id);
            if (instance==null) {
    ...
    public List findByExample(Course instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.vaannila.course.Course")
