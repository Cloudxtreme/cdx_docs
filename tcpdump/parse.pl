...
# 2011-02-11 13:18:11.348855 IP itsrv.cardiodx.com.ssh > cchoudesktop.cardiodx.com.43153: tcp 192
# 2011-02-11 13:18:11.636646 IP tiffanidesktop.cardiodx.com.netbios-ns > 10.10.39.255.netbios-ns: UDP, length 50
    ...
    my($year, $month, $day, $hour, $min, $sec, $src, $dest, $protocol) =
        ($1, $2, $3, $4, $5, $6, $7, $8, $9);
