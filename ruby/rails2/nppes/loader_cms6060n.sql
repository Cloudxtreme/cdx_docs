LOAD DATA LOCAL INFILE 'mydata.txt'
INTO TABLE cms6060n
...
(
  ...
  Provider_Business_Mailing_Address_Country_outside_US,
  ...
  Provider_Business_Practice_Location_Address_Country_outside_US,
...
set 
	Provider_Enumeration_Date = STR_TO_DATE(@Provider_Enumeration_Date, '%m/%d/%Y'),
	Last_Update_Date = STR_TO_DATE(@Last_Update_Date,'%m/%d/%Y'), 
	NPI_Deactivation_Date = STR_TO_DATE(@NPI_Deactivation_Date,'%m/%d/%Y'), 
	NPI_Reactivation_Date = STR_TO_DATE(@NPI_Reactivation_Date, '%m/%d/%Y')
;
